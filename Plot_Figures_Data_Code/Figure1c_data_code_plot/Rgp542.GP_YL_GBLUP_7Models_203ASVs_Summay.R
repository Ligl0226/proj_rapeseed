##==================================================================##
##--Description: summary the GBLUP results for YL GP 7Models for 203ASVs
...
##==================================================================##
ASVs_Traits <- colnames(YL_ASVs)  ## 203
...
for(i in 1:length(ASVs_Traits)){
  ...
  resGPi <- read.xlsx(xlsxFile = paste("./01.resGP/YL_PA_MultiOmics_7Models_203ASVs_",sprintf("%03d",i),Traiti,".xlsx",sep = ""),cols = c(2:8))
...
write.xlsx(x = resGPmeansd,"./02.SummaryGP/zResult01.GP_YL_GBLUP_MultiOmics_7Models_203ASVs_Summary.xlsx",rowNames=T)
